//! Redis test environment setup for cfgmgr integration tests
//!
//! Provides containerized Redis instances for testing configuration managers
...
///
/// Automatically starts a Redis container and provides helper methods
/// for simulating CONFIG_DB, APPL_DB, and STATE_DB operations.
